...
for activity in activities_from_json['response']['docs']:
	...
	hierarchy = activity['hierarchy'] if 'hierarchy' in activity.keys() else None
	...
	if 'related_activity_ref' in activity.keys():
		for index, related_activity in enumerate(activity['related_activity_ref'], start=0):
			if activity['related_activity_type'][index] == '2':
				...
				parent_to_child_relation.append(activity_to_activity_relation_dict)
				...
				child_to_parent_relation.append(activity_to_activity_relation_dict)
				...
				child_to_child_relation.append(activity_to_activity_relation_dict)
...
#Publish data in csv
organisation_list_df.to_csv(r'0_organisation_list.csv', index=None, header=True)
activity_list_df.to_csv(r'0_activity_list.csv', index=None, header=True)
activity_published_by_df.to_csv(r'0_org_to_activity_relation_list.csv', index=None, header=True)
parent_to_child_relation_df.to_csv(r'0_parent_to_child_relation_list.csv', index=None, header=True)
child_to_parent_relation_df.to_csv(r'0_child_to_parent_relation_list.csv', index=None, header=True)
child_to_child_relation_df.to_csv(r'0_child_to_child_relation_list.csv', index=None, header=True)
participating_org_of_df.to_csv(r'0_activity_to_participating_org_relation_list.csv', index=None, header=True)