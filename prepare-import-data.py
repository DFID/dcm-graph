...
def create_activities(tx, iatiIdentifier, title):
    tx.run("CREATE (:Activities {ActivityIdentifier: $iatiIdentifier, ActivityTitle: $title})", iatiIdentifier=iatiIdentifier, title=title)
